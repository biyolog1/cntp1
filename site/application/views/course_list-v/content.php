					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-8 col-xl-9">
							<div class="body">
								...
								<a href="<?php echo base_url("sertifika-detay/$course->url") ?>" class="btn btn-default btn-hvr hvr-shutter-out-horizontal margin-clear">Detay<i class="fa fa-arrow-right pl-10"></i></a>
							</div>
						</div>
					</div>
				</div>
