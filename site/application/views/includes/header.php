                                        ...
                                        <ul class="nav navbar-nav ">
											...
											<li class="dropdown ">
												...
												<ul class="dropdown-menu">
													...
													<li ><a href="f<?php echo base_url("sertifika-listesi")?>">Sertifikalar</a></li>
												</ul>
											</li>
											<li class="dropdown ">
												<a class="dropdown-toggle" data-toggle="dropdown" href="#">Medya</a>
												<ul class="dropdown-menu">
													<li ><a href="features-dark-page.html">Resim Galerileri</a></li>
													<li ><a href="features-dark-page.html">Reklamlar</a></li>
													<li ><a href="features-dark-page.html">Dosyalar</a></li>
												</ul>
											</li>
