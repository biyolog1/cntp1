			...
			<div class="col-sm-4">
				<div class="image-box style-2 mb-20 bordered light-gray-bg">
					...
					<div class="body">
						...
						<a href="<?php echo base_url("urun-detay/$product->url"); ?>" class="btn btn-default btn-sm btn-hvr hvr-sweep-to-right margin-clear">Detay <i class="fa fa-arrow-right pl-10"></i></a>
					</div>
				</div>
			</div>
			<?php } ?>
